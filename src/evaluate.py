...
def read_llm_response_file(filepath):
    ...
    if dataset.lower() == "commonsenseqa":
        ...
        model_accuracies, evaluation_df = evaluate_TruthfulQA(filepath)
    elif dataset.lower() == "humaneval":
        performance, evaluation_df = evaluate_HumanEval(filepath)
    else:
...
if __name__ == '__main__':
    ...
    filepath = sys.argv[1]
    csv_filepath = filepath.replace("jsonl", "csv")
