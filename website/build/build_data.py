...
Run from the repository root with the repo's venv (needs pandas):
  venv/bin/python website/build/build_data.py

The raw data is read from ../llm-edge-experiments-data/main (next to this repository),
or from the folder given in the EDGE_LLM_DATA environment variable.
"""
...
DATA_ROOT = os.environ.get("EDGE_LLM_DATA", os.path.join(os.path.dirname(REPO), "llm-edge-experiments-data", "main"))
